...
class CompanyCropFrom(forms.Form):
	name = forms.CharField(label='Nombre', max_length=256, widget=forms.TextInput(attrs={"class": "form-control input-sm"}))
	rut = forms.CharField(label='Rut', max_length=20, widget=forms.TextInput(attrs={"class": "form-control input-sm"}))

	class Meta:
		model = CompanyCrop

class CropForm(forms.Form):
	region = forms.CharField(label='Ubicacion', max_length=256, widget=forms.TextInput(attrs={"class": "form-control input-sm"}))
